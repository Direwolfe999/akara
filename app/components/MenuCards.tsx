    ...
    <section id="menu" className="py-16 px-6 max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {menuItems.map((item) => (
          <div
            key={item.id}
            className={`relative border-2 rounded-2xl p-6 flex flex-col items-center text-center transition-all hover:shadow-lg ${
              item.popular
          ...
          >
            ...
            <p className="text-2xl font-extrabold text-akara-brown mt-4">{item.price}</p>

            <button className="mt-4 w-full flex items-center justify-center gap-2 bg-akara-brown text-white py-2.5 rounded-full font-semibold hover:bg-akara-orange transition-all">
